...
public class Day6Lights {
    ...
    private static void doLights(int originx, int originy, int destx, int desty, boolean[][] lights, int mode) {
        // Mode 0 - toggle
        // Mode 1 - On
        // Mode 2 - Off
    ...
    private static void doLightsBright(int originx, int originy, int destx, int desty, int[][] lights, int mode) {
        // Mode 0 - toggle
        // Mode 1 - On
        // Mode 2 - Off
        for (int i = originx; i <= destx; i++) {
