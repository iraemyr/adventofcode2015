...
public class Day21RPG {
    ...
    private static final int[][] ARMORS = { { 0, 0, 0 }, { 13, 0, 1 }, { 31, 0, 2 }, { 53, 0, 3 }, { 75, 0, 4 },
            { 102, 0, 5 } };

    private static final int[][] RINGS = { { 0, 0, 0 }, { 0, 0, 0 }, { 20, 0, 1 }, { 25, 1, 0 }, { 40, 0, 2 },
    ...
    private static boolean heroWin(int heroHp, int heroDam, int heroArm, int bHp, int bDam, int bArm) {
        boolean h = true;
        heroDam -= bArm;
        if (heroDam < 1)
            heroDam = 1;
